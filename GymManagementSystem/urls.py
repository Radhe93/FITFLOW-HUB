...
urlpatterns = [
    ...
    path('yoga_page/',yoga_page, name='yoga_page'),
    path('bodyBulding_page/', bodyBulding_page, name='bodyBulding_page'),
    path('basicMuscle/', basicMuscle, name='basicMuscle'),
    path('protein_page/', protein_page, name='protein_page'),
    path('cardio_page/', cardio_page, name='cardio_page'),
    path('bestequipment_page/', bestequipment_page, name='bestequipment_page')
